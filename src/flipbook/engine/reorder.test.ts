...
describe('targetIndex', () => {
	...
	/* The pitch is measured off the sheet of paper, and for the frame before it has been
	   laid out it is zero. Dividing by it would hand `NaN` to the scene as a page number. */
	it('stands still when there is no pitch yet', () => {
